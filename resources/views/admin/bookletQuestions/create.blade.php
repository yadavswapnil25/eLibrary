                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="question_type" class="form-control @error('question_type') is-invalid @enderror" name="question_type">
                                            ...
                                            <option value="notes" {{ old('question_type') == 'notes' ? 'selected' : '' }}>Notes</option>
                                            <option value="que_paper" {{ old('question_type') == 'que_paper' ? 'selected' : '' }}>Question Paper</option>
                                            <option value="video" {{ old('question_type') == 'video' ? 'selected' : '' }}>Video</option>
                                            <option value="subject" {{ old('question_type') == 'subject' ? 'selected' : '' }}>Subject</option>
                                            <option value="syllabus" {{ old('question_type') == 'syllabus' ? 'selected' : '' }}>Syllabus</option>
...
<script>
    ...
    questionType.addEventListener('change', function() {
        ...
        // }
        if (questionType.value === 'notes' || questionType.value === 'que_paper' || questionType.value === 'subject' || questionType.value === 'syllabus') {
    imageUploader.style.display = 'block';
    pdfUploader.style.display = 'block';
    videoUploader.style.display = 'none';
}
